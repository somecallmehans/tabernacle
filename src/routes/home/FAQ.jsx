...
export default function FAQ() {
  return (
    <div className="p-8">
      ...
      <div className="text-2xl font-bold border-0 border-t  mb-2 border-slate-400">
        League Schedule
      </div>
      <p>
      ...
      <p>
        ...
        assignments for round one are random. In round two, pod assignments are
        ranked by league standings: players with the most points are grouped
        together, as are players with the fewest points.
      </p>
      <p>
        ...
        players can’t gain life, damage can’t be prevented, and extra turns are
        skipped. Each player may play one more full turn, after which the game
        is a draw.
      </p>
      ...
      <p>
        ...
        league game that they participate in. These packs begin in each player’s
        command zone and may be given to other players throughout the game. When
        a pack is given away, it is removed from the game and cannot be given
        away again. At the end of the game, booster packs remaining in command
        zones must be given away.
      </p>
      <p>
        ...
        someone else. Often, players wait until the end of the game to give away
        packs, in turn order. Any mix of these approaches is fine! And if
        players would like to support the store even more (and have slightly
        more leverage in their game), they are welcome to buy premium packs for
        entry!
      </p>
      <div className="text-2xl font-bold border-0 border-t py-2 border-slate-400">
        Winning the League
      ...
      <p>
        While someone will finish with more points than others, the real winner
        is the player who has the most fun along the way. In that spirit, prizes
        for winning are much less valuable than the booster packs most players
        will earn over the course of league games.
      </p>
      <p>
      ...
      <p>
        ...
        , ultimately, just one person finalizes each season’s rules, without any
        defined process. Every effort is made to integrate community feedback
        and govern by consensus, but a more democratic model might be preferable
        someday.
      </p>
      <p>
